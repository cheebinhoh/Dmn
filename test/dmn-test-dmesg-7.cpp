...
int main(int argc, char *argv[]) {
...

  {
    ...
    auto topic1_read_handler = dmesg->openHandler(
        "topic1_read_handler", "topic1", nullptr,
    ...
    auto topic2_read_handler = dmesg->openHandler(
        "topic2_read_handler", "topic2", nullptr,
