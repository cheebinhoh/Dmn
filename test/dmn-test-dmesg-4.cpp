 ...
 * same DMesg object, first publisher will continue to write
 * to the DMesg object 3 messages, where the 2nd publisher
 * will in respond to message written by first publisher and
 * write the same message back to th DMesg and which results
...
int main(int argc, char *argv[]) {
  ...
  std::shared_ptr<dmn::DMesg::DMesgHandler> dmesgHandler = dmesg.openHandler(
