...
int main(int argc, char *argv[]) {
  ...
  auto buf = std::make_unique<dmn::Dmn_Lf_BlockingQueue<std::string>>();
  ...
  dmn::Dmn_Lf_BlockingQueue<int> int_buf{};
  int_buf.push(2);

  EXPECT_TRUE(2 == int_buf.pop());

  dmn::Dmn_Lf_BlockingQueue<std::string> string_not_move_buf{};
  ...
  dmn::Dmn_Lf_BlockingQueue<int> int_buf_2{1, 2, 3};
